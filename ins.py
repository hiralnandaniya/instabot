...
chromedriver_path = 'C:/Users/Dell/Downloads/chromedriver_win32/chromedriver.exe' # Change this to your own chromedriver path!
webdriver = webdriver.Chrome(executable_path=chromedriver_path)
sleep(2)
webdriver.get('https://www.instagram.com/accounts/login/?source=auth_switcher')
sleep(3)
#C:/Users/Dell/Desktop/chromedriver_win32 (1)/chromedriver.exe

username = webdriver.find_element_by_name('username')
username.send_keys('Please Enter your username')
password = webdriver.find_element_by_name('password')
password.send_keys('Please Enter your password')

button_login = webdriver.find_element_by_css_selector('#react-root > section > main > div > article > div > div:nth-child(1) > div > form > div:nth-child(4)')
button_login.click() 
sleep(3)
...
hashtag_list = ['travelblog', 'travelblogger']
